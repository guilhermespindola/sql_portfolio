...
select clientes.nome, clientes.id_cliente, pedidos.id_cliente, pedidos.status
from clientes
inner join pedidos
on clientes.id_cliente = pedidos.id_cliente
where pedidos.status = 'Pendente'
order by pedidos.status desc;
...
select clientes.nome, count(pedidos.id_cliente) as total_pedido
from clientes
left join pedidos
on clientes.id_cliente = pedidos.id_cliente
group by clientes.nome;

select clientes.nome, (pedidos.preco*pedidos.quantidade) as total_pedido_preco
from clientes
inner join pedidos
on clientes.id_cliente = pedidos.id_cliente;

-- Selecionei o nome, telefone e data de nascimento dos clientes que nasceram antes do ano de 1985;
...
-- Selecionei o nome e a categoria dos produtos ordenados em ordem alfabética por categoria, para cada categoria deve ser ordenada pelo nome do produto
select nome, categoria from produtos order by categoria asc, nome asc;

-- Selecionei o nome e a categoria dos produtos que tem o preço superior a 30;
select nome, preco from produtos where preco > 30;

-- Selecionei os 5 produtos mais caros do restaurante;
select nome, preco from produtos order by preco desc limit 5;

-- Fiz a cada dia da semana 2 pratos principais estão na promoção, hoje você deve selecionar 2 produtos da categoria ‘Prato Principal’ e pular 6 registros (offset = 6);
select id_produto, nome, preco, categoria from produtos where categoria = 'Prato Principal' order by id_produto limit 2 offset 6;
...
case when salario > 3000 then 'Ácima da média'
else 'Abaixo da média'
end as media_salario
from funcionarios;

insert into funcionarios (nome, cpf, data_nascimento, endereco, telefone, email, cargo, salario, data_admissao) value	
...
update clientes
SET email = 'lucas.silva@email.com', nome = 'Lucas Silva', cpf = '123.456.789-01', data_nascimento = '1990-01-15', endereco = 'Av. Brigadeiro Faria Lima, 1571, São Paulo', telefone = '11987651234', data_cadastro = '2023-01-12'
where id_cliente = 1;

update clientes
set nome = 'Ana Paula', cpf = '234.567.890-12', data_nascimento = '1985-03-22', endereco = 'Rua Oscar Freire, 1290, São Paulo', telefone = '11987652345', email = 'ana.paula@email.com', data_cadastro = '2023-01-12'
where id_cliente = 2;
...
select nome, preco, rank() over (order by preco desc) as ranking_caros from produtos limit 5;
...
insert into pedidos (id_cliente, id_funcionario, id_produto, quantidade, preco, data_pedido, status) values
	(1, 4, 1, 2, 59.80, '2024-07-01', 'Concluído'),
	(3, 4, 2, 1, 42.00, '2024-07-01', 'Concluído'),
	(6, 7, 3, 1, 37.50, '2024-07-01', 'Concluído'),
	(8, 7, 4, 3, 135.00, '2024-07-01', 'Concluído'),
	(10, 8, 5, 2, 76.00, '2024-07-02', 'Pendente'),
	(15, 8, 6, 4, 26.00, '2024-07-02', 'Concluído'),
	(22, 4, 7, 3, 15.00, '2024-07-02', 'Concluído'),
	(18, 4, 8, 2, 10.00, '2024-07-02', 'Concluído'),
	(4, 7, 9, 5, 30.00, '2024-07-02', 'Concluído'),
	(6, 7, 10, 1, 36.00, '2024-07-03', 'Concluído'),
	(9, 8, 11, 3, 96.00, '2024-07-03', 'Concluído'),
	(11, 8, 12, 1, 22.00, '2024-07-03', 'Concluído'),
	(24, 4, 13, 2, 56.00, '2024-07-03', 'Concluído'),
	(27, 4, 14, 1, 35.00, '2024-07-03', 'Concluído'),
	(17, 7, 15, 2, 84.00, '2024-07-03', 'Concluído'),
	(7, 7, 16, 3, 45.00, '2024-07-04', 'Concluído'),
	(13, 8, 17, 2, 16.00, '2024-07-04', 'Concluído'),
	(25, 8, 18, 4, 30.00, '2024-07-04', 'Concluído'),
	(22, 4, 19, 1, 12.00, '2024-07-04', 'Concluído'),
	(2, 4, 20, 2, 20.00, '2024-07-04', 'Concluído'),
	(8, 7, 2, 1, 42.00, '2024-07-04', 'Concluído'),
	(11, 7, 3, 2, 75.00, '2024-07-05', 'Concluído'),
	(18, 8, 4, 3, 135.00, '2024-07-05', 'Concluído'),
	(22, 8, 5, 1, 38.00, '2024-07-05', 'Concluído'),
	(19, 4, 6, 4, 26.00, '2024-07-05', 'Concluído'),
	(28, 4, 7, 3, 15.00, '2024-07-05', 'Concluído'),
	(1, 7, 8, 2, 10.00, '2024-07-05', 'Concluído'),
	(7, 7, 9, 5, 30.00, '2024-07-05', 'Concluído'),
	(19, 8, 10, 1, 36.00, '2024-07-05', 'Concluído'),
	(15, 8, 11, 3, 96.00, '2024-07-05', 'Concluído'),
	(24, 4, 12, 1, 22.00, '2024-07-05', 'Concluído'),
	(12, 4, 13, 2, 56.00, '2024-07-05', 'Concluído'),
	(4, 7, 14, 1, 35.00, '2024-07-05', 'Concluído'),
	(9, 7, 15, 2, 84.00, '2024-07-06', 'Concluído'),
	(18, 8, 16, 3, 45.00, '2024-07-06', 'Concluído'),
	(5, 8, 17, 2, 16.00, '2024-07-06', 'Concluído'),
	(22, 4, 18, 4, 30.00, '2024-07-06', 'Concluído'),
	(14, 4, 19, 1, 12.00, '2024-07-06', 'Concluído'),
	(19, 7, 20, 2, 20.00, '2024-07-06', 'Concluído'),
	(8, 7, 1, 2, 59.80, '2024-07-06', 'Concluído'),
	(7, 8, 2, 1, 42.00, '2024-07-06', 'Concluído'),
	(4, 8, 3, 2, 75.00, '2024-07-06', 'Concluído'),
	(21, 4, 4, 3, 135.00, '2024-07-06', 'Concluído'),
	(4, 4, 5, 1, 38.00, '2024-07-06', 'Concluído'),
	(13, 7, 6, 4, 26.00, '2024-07-06', 'Concluído'),
	(25, 7, 7, 3, 15.00, '2024-07-06', 'Concluído'),
	(7, 8, 8, 2, 10.00, '2024-07-06', 'Concluído'),
	(12, 4, 10, 1, 36.00, '2024-07-06', 'Concluído'),
	(10, 4, 11, 3, 96.00, '2024-07-06', 'Concluído');
    
-- Criei uma view chamada resumo_pedido do join entre essas tabelas
create view resumo_pedido as
select pe.id_pedido, pe.quantidade, pe.data_pedido, c.nome as nome_cliente, c.email as email_cliente, f.nome as nome_funcionario, pr.nome as nome_produto, pr.preco
from pedidos pe
...
-- Selecionei o id do pedido, nome do cliente e o total (quantidade * preco) de cada pedido da view resumo_pedido
...
select pe.id_pedido, pe.quantidade, pe.data_pedido, c.nome as nome_cliente, c.email as email_cliente, f.nome as nome_funcionario, pr.nome as nome_produto, pr.preco as preço, (pe.quantidade*pr.preco) as total
from pedidos pe
inner join clientes c on pe.id_cliente = c.id_cliente
inner join funcionarios f on pe.id_funcionario = f.id_funcionario
inner join produtos pr on pe.id_produto = pr.id_produto
...
-- Repito a consulta, utilizando o campo total adicionado
select id_pedido, quantidade, nome_cliente, preço, total from resumo_pedido;

select pedidos.id_cliente, pedidos.quantidade, pedidos.data_pedido, clientes.nome, clientes.email
from pedidos
inner join clientes
on pedidos.id_cliente = clientes.id_cliente;

select pedidos.id_cliente, pedidos.quantidade, pedidos.data_pedido, clientes.nome, clientes.email, funcionarios.nome as nome_funcionario
from pedidos
inner join clientes
on pedidos.id_cliente = clientes.id_cliente
...
select pedidos.id_cliente, pedidos.quantidade, pedidos.data_pedido, clientes.nome, clientes.email, funcionarios.nome, produtos.nome, produtos.preco
from pedidos
inner join clientes
on clientes.id_cliente = pedidos.id_cliente
inner join funcionarios
on funcionarios.id_funcionario = pedidos.id_pedido
inner join produtos
on produtos.id_produto = pedidos.id_produto;

-- Repito a consulta da pergunta anterior, com uso do EXPLAIN para verificar e compreender o JOIN que está oculto na nossa query
explain select id_pedido, quantidade, nome_cliente, preço, total from resumo_pedido;

-- Criei uma função chamada ‘BuscaIngredientesProduto’, que irá retornar os ingredientes da tabela info produtos, quando passar o id de produto como argumento (entrada) da função.
DELIMITER //
create function BuscaIngredientesProduto (pe_id_produto INT)
returns varchar(200)
reads sql data
begin 
	declare descricao_ingredientes text;
	select ingredientes into descricao_ingredientes
    from info_produtos
    where id_produto = pe_id_produto;
    return descricao_ingredientes;
end //
DELIMITER ;

-- ExecuteI a função ‘BuscaIngredientesProduto’ com o id de produto 10
...
begin
    ...
    declare valor_media_geral decimal (10, 2);
    declare valor_mensagem varchar(100);
    
    select total into valor_total_pedido
    from resumo_pedido where id_pedido = pe_id_pedido;
    
    select avg(total) into valor_media_geral
    from resumo_pedido;
    
    if valor_total_pedido IS NULL then
		set valor_mensagem = 'O total do pedido é acima da média';
    elseif valor_total_pedido < valor_media_geral then
		set valor_mensagem = 'O total do pedido é abaixo da média';
    else
		set valor_mensagem = 'O total do pedido é igual à média';
    end if;
...
select mediaPedido(5) as status_pedido_5;
select mediaPedido(6) as status_pedido_6;
...
select id_cliente, count(*) as pedido_cliente from pedidos group by id_cliente having count(*) = 1;

select id_pedido '6', coalesce (status, 'Cancelado') as status_novo
from pedidos;
...
-- Backup dos dados da tabela pedidos com o nome de backup_pedidos.
...
DELIMITER //
CREATE PROCEDURE BuscarIngredientesProduto ()
select*from produtos;